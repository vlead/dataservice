...
#+BEGIN_EXAMPLE
    institute = Institute(name=instance of class InstituteName,
                          mnemonic=String
...
***** Constructor for the Discipline
     ...
     optional. Others are mandatory.
#+BEGIN_EXAMPLE
    discipline = Discipline(name=instance of class Name,
                            mnemonic=String
...
class TestDiscipline(TestCase):
    ...
    def test_get_discipline_labs(self):                                          
        ...
        disc = Discipline(name=Name("Electronics"), mnemonic="ece")
