...
***** Constructor for the Experiment
     ...
     optional. Others are mandatory.
#+BEGIN_EXAMPLE
    experiment = Experiment(name=instance of class Name
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def __init__(self, **kwargs):
        ...
        if not isinstance(kwargs['name'], Name):
            raise TypeError('`name` attribute should be of type "Name"')
...
class TestLab(TestCase):
    ...
    def test_lab_get_by_mnemonic(self):
        print "test_lab_get_by_mnemonic"
        lab = Lab(name="DS", mnemonic="ds")
        lab.save()
        some_lab = Lab.get_by_mnemonic("ds")
        self.assertEqual(some_lab, lab)
    ...
    def test_lab_get_discipline(self):
        ...
        disc = Discipline(name="CSE", mnemonic="cse")
...
class TestInstitute(TestCase):
    ...
    def test_get_institute_labs(self):                                           
        ...
        instt = Institute(name="MIT", institute_id="mit")
        lab1 = Lab(name="Micro Controllers", mnemonic="micro", institute=instt)                   
        lab2 = Lab(name="Digital Logic Design", mnemonic="digital", institute=instt)              
        labs = [lab1, lab2]                                                      
...
class TestDiscipline(TestCase):
    ...
    def test_set_discipline_name(self):
        ...
        disc = Discipline(name="Electrical Engineering", mnemonic="eee")
        new_name = "Electrical"
    ...
    def test_get_discipline_dnc(self):
        ...
        disc = Discipline(name="CSE", mnemonic="cs", dnc=Name("James"))
    ...
    def test_get_discipline_labs(self):                                          
        ...
        disc = Discipline(name="Electronics", mnemonic="ece")
        lab1 = Lab(name="Micro Controllers", mnemonic="micro", discipline=disc)                   
        lab2 = Lab(name="Digital Logic Design", mnemonic="digital", discipline=disc)              
        labs = [lab1, lab2]                                                      
...
class TestExperiment(TestCase):
    ...
    def test_experiment_constructor(self):
        ...
        name = Name("Searching and Sorting")
        ...
        expt = Experiment(name=name, content_url=content_url, simulation_url=simulation_url)
        ...
        # Calling the experiment constructor without name argument
    ...
    def test_get_content_url(self):
        ...
        expt = Experiment(name=Name("Searching and Sorting"), content_url=URL("http://vlabs.ac.in"))
    ...
    def test_get_simulation_url(self):
        ...
        expt = Experiment(name=Name("Searching and Sorting"), simulation_url=URL("http://vlabs.ac.in"))
    ...
    def test_get_id_of_experiment(self):
        ...
        expt = Experiment(name=Name("Simple Pendulum"))
        expt.save()       
        expt_id = expt.get_id()
    ...
    def test_get_experiment_by_id(self):
        ...
        expt = Experiment(name=Name("Simple Pendulum"))
        expt.save()
        self.assertEqual(expt.get_experiment(1).name, "Simple Pendulum")
    ...
    def test_get_experiment_technologies(self):
        ...
        tech2 = Technology(name="apache2")
        techs = [tech1, tech2]
        expt = Experiment(name=Name("Simple Pendulum"), technologies=techs)
        self.assertItemsEqual(expt.get_technologies(), techs)

    def test_get_experiment_lab(self):
        print "test_get_experiment_lab"
        lab = Lab(name="Data Structures", mnemonic="dsa")
        expt = Experiment(name=Name("Merge Sort"))
        lab.add_experiment(expt)
    ...
    def test_experiment_content_hosted_on(self):
        ...
        expt = Experiment(name=Name("Simple Pendulum"), content_hosted_on=platform)
    ...
    def test_experiment_simulation_hosted_on(self):
        ...
        platform = HostingPlatform(name="IIIT")
        expt = Experiment(name=Name("Simple Pendulum"), simulation_hosted_on=platform)
    ...
    def test_set_experiment_content_hosted_on(self):
        ...
        expt = Experiment(name=Name("Pendulum"))
        plat = HostingPlatform(name="IIIT")
