...
class TestLab(TestCase):
    ...
    def test_lab_get_lab_hosted_on(self):
        print "test_get_lab_hosted_on"
...
class TestDeveloper(TestCase):
    ...
    def test_developer_get_all_developers(self):
        print "test_developer_get_all_developers"
        inst = create_institute("MIT", "mit", "John", "Blake")
    ...
    def test_developer_get_institute(self):
        ...
        developer = create_developer("Thirumal Ravula",
                                     "travula@gmail.com", inst)
        developer.save()
        institute = developer.get_institute()
        self.assertEqual("MIT", institute.name)
    ...
    def test_developer_set_institute(self):
        ...
        developer.save()
        dev = Developer.get_by_id(1)
        self.assertEqual("Purdue", dev.institute.name)
...
class TestExperiment(TestCase):
    ...
    def test_get_experiment_lab(self):
        ...
        lab = Lab(name="Data Structures", mnemonic="dsa", experiments=[expt])
