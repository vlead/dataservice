...
class TestExperiment(TestCase):
    ...
    def test_get_content_url(self):
        ...
        expt = Experiment(name="Searching and Sorting", content_url=URL("http://vlabs.ac.in"))
    ...
    def test_get_simulation_url(self):
        ...
        expt = Experiment(name="Searching and Sorting", simulation_url=URL("http://vlabs.ac.in"))
    ...
    def test_get_id_of_experiment(self):
        ...
        expt = Experiment(name="Simple Pendulum")
        expt.save()       
        expt_id = expt.get_id()
    ...
    def test_get_experiment_technologies(self):
        ...
        tech2 = Technology(name="apache2")
        techs = [tech1, tech2]
        expt = Experiment(name="Simple Pendulum", technologies=techs)
    ...
    def test_experiment_remove_technology(self):
        ...
        tech = Technology(name="php5")
        expt = Experiment(name="Pendulum", technologies=[tech])
        self.assertEqual(len(expt.get_technologies()), 1)
    ...
    def test_get_experiment_lab(self):
        ...
        expt = Experiment(name="Merge Sort")
    ...
    def test_experiment_content_hosted_on(self):
        ...
        expt = Experiment(name="Simple Pendulum", content_hosted_on=platform)
    ...
    def test_experiment_simulation_hosted_on(self):
        ...
        platform = HostingPlatform(name="IIIT")
        expt = Experiment(name="Simple Pendulum", simulation_hosted_on=platform)
...
SQLALCHEMY_DATABASE_URI =\
    'mysql+oursql://root:root@localhost/vlabs_database'
